%Число называется совершенным, если равно сумме своих делителей, назовем число
%избыточным, если сумма его делителей больше самого числа. Минимальное число с
%избытком – это 12 Найдите количество чисел, меньшее 20000, которые нельзя представить
%в виде суммы двух чисел с избытком.
